...
const PriceCalculator = () => {
  ...
  const shopId = "d154ab3d-9e1b-49eb-8d07-1ee269411b1e";
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.token) {
          ...
          const checkoutUrl = `https://checkout.kh-heizol.de/checkout?token=${data.token}`;
      ...
      toast({
        ...
        description: "Bitte versuchen Sie es später erneut oder kontaktieren Sie uns telefonisch unter 089 416 133 45.",
        variant: "destructive"
      });
    } finally {
      setIsLoading(false);
