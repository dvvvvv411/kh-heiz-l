        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Gültig ab 01.01.2025 für KH Petrol Trading GmbH
            </p>
          </div>
          ...
          <Card className="shadow-lg mb-8">
            ...
            <CardContent>
              <p className="text-gray-700 text-sm leading-relaxed">
                Diese Allgemeinen Geschäftsbedingungen gelten für alle Lieferungen und Leistungen der KH Petrol Trading GmbH, Lueginslandgäßchen 2, 86152 Augsburg (nachfolgend "Verkäufer" genannt) an Verbraucher und Unternehmer (nachfolgend "Kunden" genannt). Abweichende Bedingungen des Kunden werden nicht anerkannt, es sei denn, der Verkäufer stimmt ihrer Geltung ausdrücklich schriftlich zu.
              </p>
            </CardContent>
          </Card>
